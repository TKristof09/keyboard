...
pub const IC_SAR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044008),
...
pub const IC_SS_SCL_HCNT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044014),
...
pub const IC_SS_SCL_LCNT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044018),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_FS_SCL_HCNT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x4004401c),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_FS_SCL_LCNT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044020),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_RX_TL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044038),
...
pub const IC_TX_TL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x4004403c),
    pub fn write(self: @This(), v: u8) void {
        const mask = comptime helpers.generateMask(0, 8);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_INTR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044040),
...
pub const IC_CLR_RX_UNDER = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044044),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_RX_OVER = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044048),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_TX_OVER = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x4004404c),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_RD_REQ = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044050),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_TX_ABRT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044054),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_RX_DONE = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044058),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_ACTIVITY = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x4004405c),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_STOP_DET = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044060),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_START_DET = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044064),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_GEN_CALL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044068),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_TXFLR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044074),
...
pub const IC_RXFLR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044078),
    pub fn write(self: @This(), v: u5) void {
        const mask = comptime helpers.generateMask(0, 5);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_SLV_DATA_NACK_ONLY = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044084),
...
pub const IC_DMA_TDLR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x4004408c),
...
pub const IC_DMA_RDLR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044090),
    pub fn write(self: @This(), v: u4) void {
        const mask = comptime helpers.generateMask(0, 4);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_SDA_SETUP = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044094),
    pub fn write(self: @This(), v: u8) void {
        const mask = comptime helpers.generateMask(0, 8);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_ACK_GENERAL_CALL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40044098),
...
pub const IC_FS_SPKLEN = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x400440a0),
    pub fn write(self: @This(), v: u8) void {
        const mask = comptime helpers.generateMask(0, 8);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_CLR_RESTART_DET = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x400440a8),
    pub fn write(self: @This(), v: u1) void {
        const mask = comptime helpers.generateMask(0, 1);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IC_COMP_VERSION = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x400440f8),
...
pub const IC_COMP_TYPE = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x400440fc),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const I2C0_p = struct {
    comptime base_address: *volatile u32 = @ptrFromInt(0x40044000),
