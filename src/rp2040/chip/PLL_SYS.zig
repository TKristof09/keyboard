...
pub const FBDIV_INT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x40028008),
...
pub const PLL_SYS_p = struct {
    comptime base_address: *volatile u32 = @ptrFromInt(0x40028000),
