...
pub const CTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200000),
...
pub const FSTAT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200004),
    pub const FieldMasks = struct {
...
pub const FDEBUG = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200008),
    pub const FieldMasks = struct {
...
pub const FLEVEL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020000c),
    pub const FieldMasks = struct {
...
pub const TXF0 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200010),
...
pub const TXF1 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200014),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const TXF2 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200018),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const TXF3 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020001c),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const RXF0 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200020),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const RXF1 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200024),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const RXF2 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200028),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const RXF3 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020002c),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const IRQ = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200030),
    pub fn clear(self: @This()) void {
...
pub const IRQ_FORCE = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200034),
...
pub const INPUT_SYNC_BYPASS = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200038),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const DBG_PADOUT = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020003c),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const DBG_PADOE = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200040),
    pub fn write(self: @This(), v: u32) void {
        const mask = comptime helpers.generateMask(0, 32);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const DBG_CFGINFO = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200044),
    pub const FieldMasks = struct {
...
pub const INSTR_MEM0 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200048),
...
pub const INSTR_MEM1 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020004c),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM2 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200050),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM3 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200054),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM4 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200058),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM5 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020005c),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM6 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200060),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM7 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200064),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM8 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200068),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM9 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020006c),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM10 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200070),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM11 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200074),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM12 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200078),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM13 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020007c),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM14 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200080),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM15 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200084),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM16 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200088),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM17 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020008c),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM18 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200090),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM19 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200094),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM20 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200098),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM21 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020009c),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM22 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000a0),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM23 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000a4),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM24 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000a8),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM25 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000ac),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM26 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000b0),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM27 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000b4),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM28 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000b8),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM29 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000bc),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM30 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000c0),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const INSTR_MEM31 = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000c4),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM0_CLKDIV = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000c8),
    pub const FieldMasks = struct {
...
pub const SM0_EXECCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000cc),
    pub const FieldMasks = struct {
...
pub const SM0_SHIFTCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000d0),
    pub const FieldMasks = struct {
...
pub const SM0_ADDR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000d4),
...
pub const SM0_INSTR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000d8),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM0_PINCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000dc),
    pub const FieldMasks = struct {
...
pub const SM1_CLKDIV = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000e0),
    pub const FieldMasks = struct {
        pub const INT: u32 = helpers.generateMask(16, 32);
        pub const FRAC: u32 = helpers.generateMask(8, 16);
    };
...
pub const SM1_EXECCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000e4),
    pub const FieldMasks = struct {
        pub const EXEC_STALLED: u32 = helpers.generateMask(31, 32);
        pub const SIDE_EN: u32 = helpers.generateMask(30, 31);
        pub const SIDE_PINDIR: u32 = helpers.generateMask(29, 30);
...
pub const SM1_SHIFTCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000e8),
    pub const FieldMasks = struct {
        pub const FJOIN_RX: u32 = helpers.generateMask(31, 32);
        pub const FJOIN_TX: u32 = helpers.generateMask(30, 31);
        pub const PULL_THRESH: u32 = helpers.generateMask(25, 30);
...
pub const SM1_ADDR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000ec),
    pub fn write(self: @This(), v: u5) void {
        const mask = comptime helpers.generateMask(0, 5);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM1_INSTR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000f0),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM1_PINCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000f4),
    pub const FieldMasks = struct {
        pub const SIDESET_COUNT: u32 = helpers.generateMask(29, 32);
        pub const SET_COUNT: u32 = helpers.generateMask(26, 29);
        pub const OUT_COUNT: u32 = helpers.generateMask(20, 26);
...
pub const SM2_CLKDIV = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000f8),
    pub const FieldMasks = struct {
        pub const INT: u32 = helpers.generateMask(16, 32);
        pub const FRAC: u32 = helpers.generateMask(8, 16);
    };
...
pub const SM2_EXECCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x502000fc),
    pub const FieldMasks = struct {
        pub const EXEC_STALLED: u32 = helpers.generateMask(31, 32);
        pub const SIDE_EN: u32 = helpers.generateMask(30, 31);
        pub const SIDE_PINDIR: u32 = helpers.generateMask(29, 30);
...
pub const SM2_SHIFTCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200100),
    pub const FieldMasks = struct {
        pub const FJOIN_RX: u32 = helpers.generateMask(31, 32);
        pub const FJOIN_TX: u32 = helpers.generateMask(30, 31);
        pub const PULL_THRESH: u32 = helpers.generateMask(25, 30);
...
pub const SM2_ADDR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200104),
    pub fn write(self: @This(), v: u5) void {
        const mask = comptime helpers.generateMask(0, 5);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM2_INSTR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200108),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM2_PINCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020010c),
    pub const FieldMasks = struct {
        pub const SIDESET_COUNT: u32 = helpers.generateMask(29, 32);
        pub const SET_COUNT: u32 = helpers.generateMask(26, 29);
        pub const OUT_COUNT: u32 = helpers.generateMask(20, 26);
...
pub const SM3_CLKDIV = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200110),
    pub const FieldMasks = struct {
        pub const INT: u32 = helpers.generateMask(16, 32);
        pub const FRAC: u32 = helpers.generateMask(8, 16);
    };
...
pub const SM3_EXECCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200114),
    pub const FieldMasks = struct {
        pub const EXEC_STALLED: u32 = helpers.generateMask(31, 32);
        pub const SIDE_EN: u32 = helpers.generateMask(30, 31);
        pub const SIDE_PINDIR: u32 = helpers.generateMask(29, 30);
...
pub const SM3_SHIFTCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200118),
    pub const FieldMasks = struct {
        pub const FJOIN_RX: u32 = helpers.generateMask(31, 32);
        pub const FJOIN_TX: u32 = helpers.generateMask(30, 31);
        pub const PULL_THRESH: u32 = helpers.generateMask(25, 30);
...
pub const SM3_ADDR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020011c),
    pub fn write(self: @This(), v: u5) void {
        const mask = comptime helpers.generateMask(0, 5);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM3_INSTR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200120),
    pub fn write(self: @This(), v: u16) void {
        const mask = comptime helpers.generateMask(0, 16);
        helpers.hwWriteMasked(self.reg, helpers.toU32(v) << 0, mask);
    }
...
pub const SM3_PINCTRL = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200124),
    pub const FieldMasks = struct {
        pub const SIDESET_COUNT: u32 = helpers.generateMask(29, 32);
        pub const SET_COUNT: u32 = helpers.generateMask(26, 29);
        pub const OUT_COUNT: u32 = helpers.generateMask(20, 26);
...
pub const INTR = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200128),
    pub const FieldMasks = struct {
...
pub const IRQ0_INTE = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020012c),
    pub const FieldMasks = struct {
        pub const SM3: u32 = helpers.generateMask(11, 12);
        pub const SM2: u32 = helpers.generateMask(10, 11);
        pub const SM1: u32 = helpers.generateMask(9, 10);
...
pub const IRQ0_INTF = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200130),
    pub const FieldMasks = struct {
        pub const SM3: u32 = helpers.generateMask(11, 12);
        pub const SM2: u32 = helpers.generateMask(10, 11);
        pub const SM1: u32 = helpers.generateMask(9, 10);
...
pub const IRQ0_INTS = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200134),
    pub const FieldMasks = struct {
        pub const SM3: u32 = helpers.generateMask(11, 12);
        pub const SM2: u32 = helpers.generateMask(10, 11);
        pub const SM1: u32 = helpers.generateMask(9, 10);
...
pub const IRQ1_INTE = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200138),
    pub const FieldMasks = struct {
        pub const SM3: u32 = helpers.generateMask(11, 12);
        pub const SM2: u32 = helpers.generateMask(10, 11);
        pub const SM1: u32 = helpers.generateMask(9, 10);
...
pub const IRQ1_INTF = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x5020013c),
    pub const FieldMasks = struct {
        pub const SM3: u32 = helpers.generateMask(11, 12);
        pub const SM2: u32 = helpers.generateMask(10, 11);
        pub const SM1: u32 = helpers.generateMask(9, 10);
...
pub const IRQ1_INTS = struct {
    comptime reg: *volatile u32 = @ptrFromInt(0x50200140),
    pub const FieldMasks = struct {
        pub const SM3: u32 = helpers.generateMask(11, 12);
        pub const SM2: u32 = helpers.generateMask(10, 11);
        pub const SM1: u32 = helpers.generateMask(9, 10);
...
pub const PIO0_p = struct {
    comptime base_address: *volatile u32 = @ptrFromInt(0x50200000),
